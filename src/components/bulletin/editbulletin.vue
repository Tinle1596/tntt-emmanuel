        ...
        <v-container>
          <validation-observer ref="observer" v-slot="{ invalid }">
            <v-form>
              ...
              <v-btn color="primary" @click="onUpdate()" :disabled="invalid"
                >Update</v-btn
              >
            </v-form>
          </validation-observer>
...
export default {
  ...
  methods: {
    ...
    onUpdate() {
      this.updateBulletin(this.bulletin);
    },
  },
  created() {
