const state = {
    ...
    english: {
        ...
        ourFoundation: "The Eucharistic Youth Movement utilizes God's Word in the Scriptures and the teaching of the Catholic Church as the basis for educating and guiding the youth in its activities.",
        ourIdeal: 'Eucharistic Youth Movement accepts the Eucharistic Jesus Christ as its focal point, as source of spiritual life, and as ideal for the life of its members.',
        ourPrinciples:
            [
    ...
    vietnamese: {
        ...
        ourFoundation: "Phong Trào Thiếu Nhi Thánh Thể lấy Lời Chúa trong Thánh Kinh và Giáo Huấn của Giáo Hội Công Giáo làm nền tảng để giáo dục và hướng dẫn giới trẻ trong các hoạt động.",
        ourIdeal: 'Phong Trào Thiếu Nhi Thánh Thể nhận Chúa Giêsu Thánh Thể là trung tâm điểm, là nguồn sống thiêng liêng và là lý tưởng sống của đời mình.',
        ourPrinciples:
            [
